...
<!-- <div class="d-flex gap-2 justify-content-center py-5"> <span class="badge d-flex align-items-center p-1 pe-2 text-primary-emphasis bg-primary-subtle border border-primary-subtle rounded-pill"> <img class="rounded-circle me-1" width="24" height="24" src="./assets/img/me.jpg" alt="">Primary
</span> <span class="badge d-flex align-items-center p-1 pe-2 text-secondary-emphasis bg-secondary-subtle border border-secondary-subtle rounded-pill"> <img class="rounded-circle me-1" width="24" height="24" src="./assets/img/me.jpg" alt="">Secondary
</span> <span class="badge d-flex align-items-center p-1 pe-2 text-success-emphasis bg-success-subtle border border-success-subtle rounded-pill"> <img class="rounded-circle me-1" width="24" height="24" src="./assets/img/me.jpg" alt="">Success
</span> <span class="badge d-flex align-items-center p-1 pe-2 text-danger-emphasis bg-danger-subtle border border-danger-subtle rounded-pill"> <img class="rounded-circle me-1" width="24" height="24" src="./assets/img/me.jpg" alt="">Danger
</span> <span class="badge d-flex align-items-center p-1 pe-2 text-warning-emphasis bg-warning-subtle border border-warning-subtle rounded-pill"> <img class="rounded-circle me-1" width="24" height="24" src="./assets/img/me.jpg" alt="">Warning
</span> <span class="badge d-flex align-items-center p-1 pe-2 text-info-emphasis bg-info-subtle border border-info-subtle rounded-pill"> <img class="rounded-circle me-1" width="24" height="24" src="./assets/img/me.jpg" alt="">Info
</span> <span class="badge d-flex align-items-center p-1 pe-2 text-dark-emphasis bg-light-subtle border border-dark-subtle rounded-pill"> <img class="rounded-circle me-1" width="24" height="24" src="./assets/img/me.jpg" alt="">Light
</span> <span class="badge d-flex align-items-center p-1 pe-2 text-dark-emphasis bg-dark-subtle border border-dark-subtle rounded-pill"> <img class="rounded-circle me-1" width="24" height="24" src="./assets/img/me.jpg" alt="">Dark
</span> </div> -->
...
<!-- <div class="row" data-masonry="{&quot;percentPosition&quot;: true }">
            <div class="col-sm-12 col-lg-6 mb-6">
                <div class="card">
                    <svg aria-label="Placeholder: Image cap" class="bd-placeholder-img card-img-top" height="200" preserveAspectRatio="xMidYMid slice" role="img" width="100%" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- <div class="col-sm-6 col-lg-4 mb-4">
                <div class="card">
                    <svg aria-label="Placeholder: Card image" class="bd-placeholder-img card-img" height="260" preserveAspectRatio="xMidYMid slice" role="img" width="100%" xmlns="http://www.w3.org/2000/svg">
                        <title>Placeholder</title>
                        <rect width="100%" height="100%" fill="#868e96"></rect>
...
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec risus libero, elementum ac massa vitae, cursus pellentesque dui. Sed gravida, elit in molestie aliquam, ex massa convallis lectus, dignissim mattis mauris est a enim. Donec non euismod ipsum. Donec scelerisque maximus urna ac consectetur. Sed placerat tempor tellus non facilisis. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Morbi quam erat, viverra a eleifend id, condimentum sed quam. Vestibulum congue placerat nulla, vel molestie libero vulputate in.</p>

<p>Suspendisse dolor leo, pellentesque congue tortor ut, placerat malesuada ligula. Vivamus consequat euismod sollicitudin. Proin dui ex, accumsan sit amet rhoncus ut, gravida vel felis. Etiam massa odio, sagittis et vulputate non, finibus congue mauris. Etiam placerat ultricies sem vitae ornare. Phasellus maximus lobortis turpis, non varius nibh sagittis id. Aenean luctus velit velit, quis condimentum elit pellentesque in. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>

<p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Nunc laoreet ultrices feugiat. Donec scelerisque libero at fermentum sagittis. Nam a nisl finibus, fringilla ex ac, dictum purus. Suspendisse potenti. Morbi tincidunt est eu interdum gravida. Morbi condimentum molestie quam id laoreet. Curabitur urna mauris, posuere a elementum non, faucibus a velit. Aliquam est quam, tempus sed libero eu, molestie accumsan orci. Aenean sit amet lacinia massa. Sed ultrices varius vestibulum. Vivamus mauris tortor, efficitur pretium ullamcorper vitae, facilisis non enim. Nullam rhoncus enim sed faucibus suscipit. Aliquam ut vestibulum purus.</p>
